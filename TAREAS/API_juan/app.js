...
//consulta general
app.get('/API_juan/api/articulos', (req, res) => {
...
app.get('/API_juan/api/articulos/:id', (req, res) => {
...
app.post('/API_juan/api/articulos', (req, res) => {
...
//para editar
app.put('/API_juan/api/articulos:id', (req, res) => {
...
//eliminar
app.delete('/API_juan/api/articulos:id', (req, res) => {
