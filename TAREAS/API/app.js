...
//consulta general
app.get('/API/api/articulos', (req, res) => {
...
app.get('/API/api/articulos/:id', (req, res) => {
...
app.post('/API/api/articulos', (req, res) => {
...
//para editar
app.put('/API/api/articulos:id', (req, res) => {
...
//eliminar
app.delete('/API/api/articulos:id', (req, res) => {
